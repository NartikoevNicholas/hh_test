...
def get_neighbours(x, y):
    ...
    for element in list_neighbours:
        if data_drop_set.__contains__(element):
...
if __name__ == '__main__':
    ...
    # вводные данные
    data_const_set = set()  # Множество с постоянными данными
    data_drop_set = set()  # Множество с переменными данными, которые в итоге мы все выбросим
    ...
    for i in range(100):
        for j in range(100):
            data_drop_set.add((i, j))
            data_const_set.add((i, j))
    ...
    while data_drop_set:
        ...
        while all_neighbours:
            ...
            data_drop_set.discard(temp_field)
        ...
        for i in range(y):
            ...
            for j in range(x):
                ...
                if data_const_set.__contains__(inner_point):
